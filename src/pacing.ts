...
/** The gap held after one point of the path the pointer travels. */
export function drawPointerStepGapMs(): number {
  return drawFromPace(activePace.pointerStepGapMs);
}
